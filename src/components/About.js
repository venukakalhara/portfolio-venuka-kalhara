      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="grid gap-3 sm:gap-6 grid-cols-3 mt-12">
          ...
          >
            ...
            <p className="text-[10px] sm:text-sm text-gray-500 dark:text-gray-400 leading-snug sm:leading-relaxed font-light">HTML5, CSS3, JavaScript (ES6+), React.js, Tailwind CSS, Node.js, Express.js, MongoDB, SQL</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[10px] sm:text-sm text-gray-500 dark:text-gray-400 leading-snug sm:leading-relaxed font-light break-words">BSc (Hons) in Information Technology – SLIIT</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[10px] sm:text-sm text-gray-500 dark:text-gray-400 leading-snug sm:leading-relaxed font-light">HCI, UI/UX, and Web Development projects</p>
          </motion.div>
        </div>
